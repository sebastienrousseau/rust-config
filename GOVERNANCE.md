...
This document describes how @sebastienrousseau/rust-config is run: who decides what, how
...
@sebastienrousseau/rust-config is **maintainer-led**. As of the current release line it has a single
