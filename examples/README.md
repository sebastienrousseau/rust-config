# `@sebastienrousseau/rust-config` Examples Catalog

This directory provides runnable, standalone examples covering **100% of the functionalities and features** provided by `@sebastienrousseau/rust-config`.
...
- [x] **rustfmt.toml**: Standardized rule preset
- [x] **clippy.toml**: Standardized rule preset
